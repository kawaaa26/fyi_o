...
class SnapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snap" do
    assert_difference('Snap.count') do
      post snaps_url, params: { snap: { detail: @snap.detail, image: @snap.image, name: @snap.name } }
    end
  ...
  test "should update snap" do
    patch snap_url(@snap), params: { snap: { detail: @snap.detail, image: @snap.image, name: @snap.name } }
