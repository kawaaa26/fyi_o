...
class SnapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snap" do
    assert_difference('Snap.count') do
      post snaps_url, params: { snap: { detail: @snap.detail, images: @snap.images, title: @snap.title } }
    end
  ...
  test "should update snap" do
    patch snap_url(@snap), params: { snap: { detail: @snap.detail, images: @snap.images, title: @snap.title } }
