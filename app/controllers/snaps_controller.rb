class SnapsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @snap.save
        format.html { redirect_to @snap, notice: 'Snapが投稿できました！' }
  ...
  def update
    respond_to do |format|
      if @snap.update(snap_params)
        format.html { redirect_to @snap, notice: 'Snapの編集ができました！' }
  ...
  def destroy
    @snap.destroy
    respond_to do |format|
      format.html { redirect_to snaps_url, notice: 'Snapが削除されました！' }
